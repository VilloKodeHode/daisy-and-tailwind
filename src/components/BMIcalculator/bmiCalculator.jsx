...
function BmiCalculator() {
  return (
    <div>
      ...
      <input type="number" placeholder="Height (M. Ex. 1.8)" id="inputHeight" />
      <input type="number" placeholder="Weight (KG. Ex. 80)" id="inputWeight" />
      <button onClick={() => calculateBmi()} id="bmiButton">
        Calculate BMI
      </button>
      <p id="bmiResult"></p>
    </div>
